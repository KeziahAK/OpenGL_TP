...
//         glm::mat4 earthMVMatrix = glm::rotate(globalMVMatrix*ViewMatrix, time, glm::vec3(0, 1, 0));
//         glUniformMatrix4fv(earthProgram.u_mv, 1, GL_FALSE, glm::value_ptr(earthMVMatrix*ViewMatrix));
...
//             moonMVMatrix=glm::rotate(moonMVMatrix*ViewMatrix, time, glm::vec3(angle[i].x,0,angle[i].z));
